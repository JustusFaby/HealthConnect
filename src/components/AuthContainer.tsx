          ...
          <div className="p-12 md:p-16">
            {activeTab === 'login' ? (
              <div className="space-y-7">
                ...
                <div>
                  <label className="mb-1.5 block text-base font-medium text-gray-700">Email</label>
                  <div className="relative">
                ...
                <div>
                  <label className="mb-1.5 block text-base font-medium text-gray-700">Password</label>
                  <div className="relative">
                ...
                <p className="text-center text-xs text-gray-400">Demo: admin@admin.com / admin123</p>
              </div>
            ) : (
              <div className="space-y-7">
                {regRole === 'patient' && (
                ...
                <div>
                  <label className="mb-2 block text-base font-medium text-gray-700">I am a</label>
                ...
                <div>
                  <label className="mb-1.5 block text-base font-medium text-gray-700">Full Name</label>
                  <div className="relative">
                ...
                {regRole === 'doctor' && (
                  <div>
                    <label className="mb-1.5 block text-base font-medium text-gray-700">Specialization</label>
                    <div className="relative">
